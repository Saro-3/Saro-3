...
An NLP-based web application that analyzes tweet sentiments using **Python, TextBlob, Pandas, and Streamlit**.
...
A smart assistive device developed using **Arduino Nano, ESP32, Ultrasonic Sensors, and IR Sensors** to help visually impaired users detect obstacles and pits.
...
- Generative AI for Educators with Gemini – Google
...
⭐ *"Continuous learning and consistent practice build great software engineers."*
...
<!--
**Saro-3/Saro-3** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
